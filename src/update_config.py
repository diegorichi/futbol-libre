...
class UpdateConfig:
    ...
    def from_environment(cls):
        ...
        return cls({
            ...
            "m3u": setting("M3U_FILE", str(Path.cwd() / "eventos.m3u")),
            "xml": setting("XML_FILE"), "events": setting("TV_EVENTS_FILE"),
            "agenda": setting("AGENDA_FILE", str(Path.cwd() / "agenda_web.json")),
            ...
            "progress": os.path.abspath(setting("PROGRESS_FILE", str(Path(__file__).parent.parent / ".update-futbollibre.progress.json"))),
        })
